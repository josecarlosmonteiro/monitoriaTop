	...
	<div class="container">
		<header class="background">
			<div class="nav">
        		...
        		<div class="title">
      				<h1>Monitoria <font color="red">Digital</font> - IFPE</h1><br>
      				<h4>Ser monitor agora <font color="white">ficou muito mais fácil</font></h4>
      			</div>
		</header>
		<center>
			<!-- aqui arthur  áre dos cards são 3 cards 1 QACADEMICO, 2 SITE DO IF, 3 (OUTROS)-->
			<div class="cards">
				<h1>Área de links Externos onde ficarão os cards.</h1><br>
				<h2>IN PROGRESS...</h2><br>
				<h3><font color="red"> Responsável:</font> Arthur.</h3><br>
				<h4>1 (QACADEMICO)</h4>
				<h4>2 (IFPE-SITE)</h4>
				<h4>3 (Site referente a monitoria)</h4>
			</div>
			<!-- ---------- -->
		</center>
			<footer id="footer">
